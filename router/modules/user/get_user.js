...
async function process(payload) {
  ...
  if (access === 'Nothing') {
    ...
    if (personData.id === null) {
      ...
      _re = {
        accept_at: personData.accept_at,
        id: personData.id,
        notification_seen: personData.notification_seen,
        notification_status: personData.notification_status,
        propose_at: personData.propose_at,
        relation_status: personData.relation_status,
        relation_value: personData.relation_value,
        status: personData.status,
        user_1: personData.user_1,
        user_2: personData.user_2,
      };
    }
    _user = {
