...
async function search(payload) {
  ...
  try {
    const [row, fields] = await con.query(
      `UPDATE settings SET search_history = '${payload._h}' WHERE user_id = '${payload._m}'`
    );
    _final = row;
  } catch (e) {
    _final = 'Bug';
...
async function vibration(payload) {
  ...
  try {
    const [row, fields] = await con.query(
      `UPDATE settings SET vibration = '${payload._h}' WHERE user_id = '${payload._m}'`
    );
    _final = row;
  } catch (e) {
    _final = 'Bug';
...
async function sound(payload) {
  ...
  try {
    const [row, fields] = await con.query(
      `UPDATE settings SET sound = '${payload._h}' WHERE user_id = '${payload._m}'`
    );
    _final = row;
  } catch (e) {
    _final = 'Bug';
...
async function get(payload) {
  ...
  try {
    const [row, fields] = await con.execute(
      `SELECT * FROM settings WHERE user_id = ${payload._h}`
    );
    _final = row;
  } catch (e) {
    _final = 'Bug';
...
async function privacy(payload) {
  ...
  try {
    const [row, fields] = await con.execute(
      `UPDATE settings SET privacy = '${payload._h}' WHERE user_id = '${payload._m}'`
    );
    _final = row;
  } catch (e) {
    _final = 'Bug';
...
async function messaging(payload) {
  ...
  try {
    const [row, fields] = await con.execute(
      `UPDATE settings SET messaging = '${payload._h}' WHERE user_id = '${payload._m}'`
    );
    _final = row;
  } catch (e) {
    _final = 'Bug';
...
async function delete_search(payload) {
  ...
  try {
    const [row, fields] = await con.execute(
      `DELETE FROM search_history WHERE user_id = '${payload._m}'`
    );
    _final = row;
  } catch (e) {
    _final = 'Bug';
...
async function deactivate_user(payload) {
  ...
  try {
    const [row, fields] = await con.execute(
      `UPDATE users SET u_status  = '1' WHERE id  = '${payload._m}'`
    );
    _final = row;
  } catch (e) {
    _final = 'Bug';
...
async function password_check(payload) {
  ...
  try {
    const [row, fields] = await con.execute(
      `SELECT password FROM users WHERE id = '${payload.id}';`
    );
    _final = row;
  } catch (e) {
    _final = 'Bug';
...
async function password_update(payload) {
  ...
  try {
    const [row, fields] = await con.execute(
      `UPDATE users SET password = '${payload.hash}' WHERE id = '${payload.id}';`
    );
    _final = row;
  } catch (e) {
    _final = 'Bug';
...
async function messaging_rules_delete(payload) {
  ...
  try {
    const [row, fields] = await con.execute(
      `DELETE FROM user_messaging_rules WHERE user_id = '${payload._m}'`
    );
    _final = row;
  } catch (e) {
    _final = 'Bug';
